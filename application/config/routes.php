...
$route['reports/(delivery)/(:any)/(:any)'] = "reports/$1/$2/$3";
$route['reports/delivery'] = "reports/delivery_input";
$route['reports/(driver)/(:any)/(:any)/(:any)'] = "reports/$1/$2/$3/$4";
$route['reports/driver'] = "reports/driver_input";
