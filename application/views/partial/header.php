...
<head>
	...
	<link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/navbar_style.css" />
...
<div id="menubar_footer">
		...
		<div id="nav">
		    <ul>
				<li id="t1"><a href="<?php echo site_url('home');?>">
				<?php echo $this->lang->line("module_home") ?></a></li>

			<?php
			foreach($allowed_modules->result() as $module)
			{
			?>
				<li id="t1"><a href="<?php echo site_url("$module->module_id");?>">
				<?php echo $this->lang->line("module_".$module->module_id) ?></a></li>
			<?php
			}
			?>
		    </ul>
